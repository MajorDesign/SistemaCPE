...
# --- USUARIOS ---
# 2026-09-22: UserBase/UserCreate/UserUpdate movidos pra routes/users.py
# junto com os endpoints. Ver o commit da consolidacao — este arquivo so
# mantem UserResponse (usado pelo auth_router pra montar o payload de
# /api/auth/login).
...
# 2026-09-22: users_router agora vem do modulo routes/users.py — antes
# era declarado inline nesta app.py e a versao "canonica" em routes/users.py
# ficava morta (nunca importada). Ver commit da consolidacao.
